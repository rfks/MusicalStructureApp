    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songdetailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent songdetailIntent = new Intent(LibraryActivity.this, SongDetailsActivity.class);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.add_song, Toast.LENGTH_SHORT).show();
            }
        });
    }
